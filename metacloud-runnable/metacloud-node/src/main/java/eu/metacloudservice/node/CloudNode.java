...
import eu.metacloudservice.node.commands.PasteCommand;
...
public class CloudNode {
    ...
    public CloudNode() {
        ...
        Driver.getInstance().getTerminalDriver().log(Type.INFO, Driver.getInstance().getLanguageDriver().getLang().getMessage("cloud-start-succsessfull"));
