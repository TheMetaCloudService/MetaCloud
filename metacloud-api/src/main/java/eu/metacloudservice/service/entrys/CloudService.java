...
public class CloudService {
    ...
    private LiveServices getLiveService() {
        ...
        final LiveServices services = (LiveServices) new ConfigDriver().convert(CloudAPI.getInstance().getRestDriver().get("/cloudservice/" + getName().replace(list.getCloudServiceSplitter(), "~")), LiveServices.class);
        return services;
    }


    public ServiceState getState() {
       return this.getLiveService().getState();
    }

    public String getAddress() {
        return this.getLiveService().getHost();
    }

    public Integer getPort() {
        return this.getLiveService().getPort();
    }
