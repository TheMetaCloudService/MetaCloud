...
@Plugin(id = "permissions", name = "metacloud-permissions", version = "1.0.8-RELEASE", authors = "RauchigesEtwas", dependencies = {@Dependency(id = "metacloudapi"), @Dependency(id = "metacloudplugin")})
