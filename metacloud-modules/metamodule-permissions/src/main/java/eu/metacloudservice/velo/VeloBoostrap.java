...
@Plugin(id = "permissions", name = "metacloud-permissions", version = "1.0.7-RELEASE", authors = "RauchigesEtwas", dependencies = {@Dependency(id = "metacloudapi"), @Dependency(id = "metacloudplugin")})
