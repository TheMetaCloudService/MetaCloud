...
@Plugin(id = "metacloudmodulenotify", version = "1.1.3-RELEASE", name = "metacloud-notify", authors = "RauchigesEtwas", dependencies = {@Dependency(id = "metacloudapi"), @Dependency(id = "metacloudplugin")})
