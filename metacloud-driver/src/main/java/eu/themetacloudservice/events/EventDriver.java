...
public class EventDriver {
    ...
    private final Set<ICloudEventListener> registeredListeners;
    ...
    public void registerListener(final ICloudEventListener listener) {
    ...
    private EventProcess createEventHandler(final ICloudEventListener listener, final Method method, final EventHandler annotation) {
    ...
    public void removeListener(ICloudEventListener listener) {
    ...
    public Set<ICloudEventListener> getRegisteredListeners() {
